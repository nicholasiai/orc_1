									...
									<c:forEach items="${userInfoList}" var="userInfo">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/userInfo/findById.do?id=${userInfo.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/userInfo/findUserInfoByIdAndAllRole.do?id=${userInfo.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
